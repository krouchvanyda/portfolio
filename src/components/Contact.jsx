  ...
  return (
    <Section id="contact">
      <Container>
        ...
        >
          <AppBox sx={{ position: 'absolute', top: '-40%', left: '50%', transform: 'translateX(-50%)', width: '60%', height: '100%', background: AppColors.grad, filter: 'blur(120px)', opacity: 0.28 }} />
            ...
            <Stack direction="row" spacing={3.5} justifyContent="center" sx={{ mt: '34px' }}>
              {[
                ...
                <AppBox
                  ...
                  sx={{ fontWeight: 500, color: AppColors.muted, transition: 'color .2s', '&:hover': { color: AppColors.text } }}
                >
                  {label}
                </AppBox>
              ))}
      ...
      <AppBox component="footer" sx={{ maxWidth: '1160px', mx: 'auto', mt: '70px', px: '24px', pt: '30px', borderTop: `1px solid ${AppColors.border}`, display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center', color: AppColors.muted, fontSize: '0.88rem' }}>
